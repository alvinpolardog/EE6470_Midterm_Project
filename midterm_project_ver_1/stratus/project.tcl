...
set INPUT_DIR           ".."
set IN_FILE_NAME        "${INPUT_DIR}/stimulus.dat"
...
define_sim_config V_BASIC "NEO RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "NEO RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
